...
module ReportType
  module SparqlBuilder
    ...
    module ClassMethods
      ...
      def build_phenotype_sparql(meo_id, tax_id, bp_id, mf_id, cc_id, mpo_id, select_clause, limit = 1, offset = 0)
        if [bp_id, mf_id, cc_id].any?(&:present?)
          phenotypes_has_go_condition(PREFIX, ONTOLOGY, mpo_id, meo_id, tax_id, bp_id, mf_id, cc_id, select_clause, limit, offset)
        elsif tax_id.present?
          phenotypes_has_tax_condition(PREFIX, ONTOLOGY, mpo_id, meo_id, tax_id, select_clause, limit, offset)
        elsif meo_id.present?
          phenotypes_has_meo_condition(PREFIX, ONTOLOGY, mpo_id, meo_id, select_clause, limit, offset)
        elsif mpo_id.present?
          phenotypes_has_mpo_condition(PREFIX, ONTOLOGY, mpo_id, select_clause, limit, offset)
        else
          phenotypes_init_condition(PREFIX, ONTOLOGY, select_clause, limit, offset)
        end
      end
      ...
      def_erb_method("phenotypes_init_condition(prefix, ontology, select_clause, limit, offset)", 'app/views/sparql_templates/phenotypes/init_condition.rq.erb')
      def_erb_method("phenotypes_has_mpo_condition(prefix, ontology, mpo_id, select_clause, limit, offset)", 'app/views/sparql_templates/phenotypes/has_mpo_condition.rq.erb')
      def_erb_method("phenotypes_has_meo_condition(prefix, ontology, mpo_id, meo_id, select_clause, limit, offset)", 'app/views/sparql_templates/phenotypes/has_meo_condition.rq.erb')
      def_erb_method("phenotypes_has_tax_condition(prefix, ontology, mpo_id, meo_id, tax_id, select_clause, limit, offset)", 'app/views/sparql_templates/phenotypes/has_tax_condition.rq.erb')
      def_erb_method("phenotypes_has_go_condition(prefix, ontology, mpo_id, meo_id, tax_id, bp_id, mf_id, cc_id, select_clause, limit, offset)", 'app/views/sparql_templates/phenotypes/has_go_condition.rq.erb')
      ...
      def_erb_method("find_phenotype_root_sparql(prefix, ontology, mpos)", 'app/views/sparql_templates/find_phenotype_root.rq.erb')
      #def_erb_method("find_phenotype_inhabitants_stats_sparql(prefix, ontology, mpos)", 'app/views/sparql_templates/find_phenotype_inhabitants_stats.rq.erb')
    end
  end
end
