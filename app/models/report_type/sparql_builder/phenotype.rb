  ...
  module SparqlBuilder
    module Phenotype
      ...
      module ClassMethods
        ...
        def_erb_method("init_condition(prefix, ontology, select_clause, order_clause, limit, offset)", 'app/views/sparql_templates/report_type/phenotypes/init_condition.rq.erb')
        def_erb_method("has_mpo_condition(prefix, ontology, mpo_id, select_clause, order_clause, limit, offset)", 'app/views/sparql_templates/report_type/phenotypes/has_mpo_condition.rq.erb')
        def_erb_method("has_meo_condition(prefix, ontology, mpo_id, meo_id, select_clause, order_clause, limit, offset)", 'app/views/sparql_templates/report_type/phenotypes/has_meo_condition.rq.erb')
